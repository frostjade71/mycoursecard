    ...
    <div className="relative flex min-h-screen flex-col bg-background text-text-primary antialiased">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <button className="flex items-center justify-center gap-2 rounded-input border border-border bg-white px-5 py-2 text-sm font-semibold text-text-primary shadow-sm transition-all hover:bg-surface">
        ...
        <section className="relative overflow-hidden px-6 py-20 lg:py-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <button className="rounded-input bg-primary px-8 py-4 text-base font-bold text-white shadow-lg shadow-primary/20 transition-all hover:bg-primary/90 hover:scale-[1.02]">
